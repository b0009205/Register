	...
	<body>
		...
		<div id="show-instructor" class="content scaffold-show" role="main">
			...
			<ol class="property-list instructor">
				...
				<g:if test="${instructorInstance?.instructorRoom}">
				<li class="fieldcontain">
					<span id="instructorRoom-label" class="property-label"><g:message code="instructor.instructorRoom.label" default="Instructor Room" /></span>
					
						<span class="property-value" aria-labelledby="instructorRoom-label"><g:fieldValue bean="${instructorInstance}" field="instructorRoom"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${instructorInstance?.instructorTelephone}">
				<li class="fieldcontain">
					<span id="instructorTelephone-label" class="property-label"><g:message code="instructor.instructorTelephone.label" default="Instructor Telephone" /></span>
					
						<span class="property-value" aria-labelledby="instructorTelephone-label"><g:fieldValue bean="${instructorInstance}" field="instructorTelephone"/></span>
