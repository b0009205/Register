			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="instructorRoom" title="${message(code: 'instructor.instructorRoom.label', default: 'Instructor Room')}" />
					
						<g:sortableColumn property="instructorTelephone" title="${message(code: 'instructor.instructorTelephone.label', default: 'Instructor Telephone')}" />
				...
				<g:each in="${instructorInstanceList}" status="i" var="instructorInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: instructorInstance, field: "instructorRoom")}</td>
					
						<td>${fieldValue(bean: instructorInstance, field: "instructorTelephone")}</td>
