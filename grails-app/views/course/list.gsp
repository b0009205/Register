			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="courseYear" title="${message(code: 'course.courseYear.label', default: 'Course Year')}" />
				...
				<g:each in="${courseInstanceList}" status="i" var="courseInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: courseInstance, field: "courseYear")}</td>
