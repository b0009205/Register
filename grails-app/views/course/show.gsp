			...
			<ol class="property-list course">
				...
				<li class="fieldcontain">
					<span id="courseClasses-label" class="property-label"><g:message code="course.courseClasses.label" default="Course Classes" /></span>
						...
						<span class="property-value" aria-labelledby="courseClasses-label"><g:link controller="class" action="show" id="${c.id}">${c?.encodeAsHTML()}</g:link></span>
						</g:each>
				...
				<g:if test="${courseInstance?.courseYear}">
				<li class="fieldcontain">
					<span id="courseYear-label" class="property-label"><g:message code="course.courseYear.label" default="Course Year" /></span>
					
						<span class="property-value" aria-labelledby="courseYear-label"><g:fieldValue bean="${courseInstance}" field="courseYear"/></span>
